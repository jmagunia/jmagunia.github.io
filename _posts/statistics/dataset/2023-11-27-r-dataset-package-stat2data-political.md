...
<td style="text-align: left;">How informed are you about politics? <code>1</code>=uninformed to <code>5</code>=very well informed</td>
</tr>
<tr>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-stat2data-political.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
