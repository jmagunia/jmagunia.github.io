...
<td style="text-align: left;">"Human Capital"</td>
</tr>
<tr>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-quantreg-barro.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
