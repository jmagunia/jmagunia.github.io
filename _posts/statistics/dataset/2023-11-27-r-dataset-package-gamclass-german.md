...
<p id="dataset-attachments">Attachments: <code><a target="_blank" href="/assets/data/csv/dataset-11313.csv">csv</a></code>, <code><a target="_blank" href="/assets/data/json/dataset-11313.json">json</a></code></p>
