...
<dt>oclc</dt>
<dd>
<p>number of library subscriptions</p>
</dd>
<dt>field</dt>
<dd>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-ecdat-journals.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
