...
<dd>
<p>estimated performance (by Ein-Dor &amp; Feldmesser).</p>
</dd>
</dl>
<h3>Source</h3>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-mass-cpus.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
