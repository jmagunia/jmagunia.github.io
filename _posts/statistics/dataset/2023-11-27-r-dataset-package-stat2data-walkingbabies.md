...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-stat2data-walkingbabies.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
<script>let json_file = 'dataset-55122.json';</script>