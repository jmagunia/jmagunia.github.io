...
<dt>race</dt>
<dd>
<p>Race of the mother (1=white, 2=black, 3=other)</p>
</dd>
<dt>education</dt>
<dd>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-kmsurv-pneumon.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
