...
<dt>pc3mth</dt>
<dd>
<p>Prenatal care after 3rd month (1=yes, 0=no)</p>
</dd>
</dl>
<h3>Source</h3>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-kmsurv-bfeed.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
