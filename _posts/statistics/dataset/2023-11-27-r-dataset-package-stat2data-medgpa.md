...
<td style="text-align: left;">Biological sciences (subscore)</td>
</tr>
<tr>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-stat2data-medgpa.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
