...
<dd>
<p>how often the student exercises. (Factor, with levels <code>"Freq"</code> (frequently), <code>"Some"</code>, <code>"None"</code>.)</p>
</dd>
...
{% highlight html %}
<iframe src="https://jmagunia.com/iframe/r-dataset-package-mass-survey.html" width="100%" height="100%" style="border:0px"></iframe>
{% endhighlight %}
</div>
<div id="grid"></div>
